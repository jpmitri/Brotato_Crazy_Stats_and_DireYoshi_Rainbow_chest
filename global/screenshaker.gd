...
func _on_player_took_damage(_unit:Unit, value:int, _knockback_direction:Vector2, _knockback_amount:float, _is_crit:bool, _is_miss:bool, _effect_scale:float, _hit_type:int)->void :
				if value == 0:
								return 
...
func _on_unit_took_damage(_unit:Unit, value:int, _knockback_direction:Vector2, _knockback_amount:float, _is_crit:bool, _is_miss:bool, _effect_scale:float, _hit_type:int)->void :
