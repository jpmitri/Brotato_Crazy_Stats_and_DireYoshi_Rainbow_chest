...
func _on_unit_took_damage(unit:Unit, value:int, knockback_direction:Vector2, _knockback_amount:float, _is_crit:bool, is_miss:bool, effect_scale:float, _hit_type:int)->void :
