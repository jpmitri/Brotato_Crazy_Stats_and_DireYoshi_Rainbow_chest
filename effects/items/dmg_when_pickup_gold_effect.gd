class_name DealDamageWhenPickupGoldEffect
extends Effect
...
static func get_id()->String:
	return "deal_damage_when_pickup_gold"


func apply()->void :
	RunData.effects["dmg_when_pickup_gold_from_luck"][0] += chance
	RunData.effects["dmg_when_pickup_gold_from_luck"][1] += value
