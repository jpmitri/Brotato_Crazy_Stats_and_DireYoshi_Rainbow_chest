...
var steam_id:int = 0
# var steam_id:int = 76561200612185647
...
var settings:Dictionary = {
				...
				"damage_display":true, 
				"fixed_reroll":false, 
				"rainbow_box_chance":0, 
				"shop_tag_chance":0, 
				"luck_everything":0, 
				"elites_drop_rainbow":false, 
...
func serialize_run_state()->Dictionary:
				...
				serialized_run_state.unique_effects = []
				serialized_run_state.additional_weapon_effects = []
...
func deserialize_run_state(state:Dictionary)->Dictionary:
				...
				deserialized_run_state.unique_effects = []
				deserialized_run_state.additional_weapon_effects = []
